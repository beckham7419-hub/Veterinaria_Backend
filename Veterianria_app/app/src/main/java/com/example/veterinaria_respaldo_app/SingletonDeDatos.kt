...
object SingletonDeDatos {
    ...
    init {
        ...
        arraylist_mensajes.add(3, "Ingresa tu nombre completo (Nombre, Apellido Paterno y Apellido Materno).")
        ...
        arraylist_mensajes.add(6, "La conttraseña debe de ser la misma en ambos campos")
        array_validaciones= ArrayList()
        array_validaciones.add(0, "^[A-Za-z0-9.-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$")
        array_validaciones.add(1, "^871[0-9]{7}$")
        array_validaciones.add(2, "^[A-Za-zÁÉÍÓÚÜÑáéíóúüñ]+(?: [A-Za-zÁÉÍÓÚÜÑáéíóúüñ]+){2,}$")
        array_validaciones.add(3, "^(?=.*[A-Za-zÁÉÍÓÚÜÑáéíóúüñ])(?=.*[0-9])(?!.*([A-Za-zÁÉÍÓÚÜÑáéíóúüñ])\\1{3,})[A-Za-zÁÉÍÓÚÜÑáéíóúüñ0-9#°.,\\- ]{8,100}$")
